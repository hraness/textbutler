...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630"><title>Textbutler: Your AI butler replies in the chats you choose. In development for Mac.</title><rect width="1200" height="630" fill="#f8f7f4"/>${icon}${lettering('Textbutler', 162, 107, 38)}${lettering('Your AI butler replies', 80, 275, 72)}${lettering('in the chats you choose', 80, 360, 72)}${lettering('iMessage, WhatsApp, and Beeper. Clearly marked.', 83, 426, 29, '#5c554f')}<path d="M80 505H1120" stroke="#d9d4cd"/>${lettering('textbutler.app', 80, 560, 26)}${lettering('In development for Mac', 830, 560, 23, '#5c554f')}</svg>`;

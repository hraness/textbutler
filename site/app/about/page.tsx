...
export default function AboutPage() {
  return <><SiteHeader /><main className="document-page" id="main-content" tabIndex={-1}>
    ...
    <section className="about-grid" aria-label="Product principles">
      <article><h2>Review what gets sent.</h2><p>Text replies carry a disclosure by default, starting with {'🤖{ hello this is my response }'}. You can change or clear its three symbols and review the complete outgoing text before sending.</p></article>

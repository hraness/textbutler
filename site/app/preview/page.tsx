...
export default function PreviewPage() {
  return <main id="main-content"><section className="hero" aria-labelledby="textbutler-preview-heading">
    <div className="hero-copy"><h1 id="textbutler-preview-heading">Your AI butler replies in the chats you choose.</h1><p className="lede">Turn it on for one person on iMessage, WhatsApp, or Beeper, and it replies as a clearly marked assistant that knows your history with them. Its optional menu bar companion uses a prebuilt runner.</p><p className="lede">{SITE_STATUS}</p></div>

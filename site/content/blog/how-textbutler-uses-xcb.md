...
xcb's documentation names Textbutler as the reference consumer of that mode. Textbutler accepts xcb accounts for Claude Code, Codex and Devin, and a provider still has to pass its checks before any drafting runs on it.
